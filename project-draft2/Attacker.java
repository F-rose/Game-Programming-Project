...
public class Attacker {			
	...
	public Attacker (JPanel panel, TileMap t, BackgroundManager b, Player player) {
		this.panel = panel;
		...
		this.player = player;
		playerLeftImage = ImageManager.loadImage("images/playerLeft.gif"); // replace with attacker image
		playerRightImage = ImageManager.loadImage("images/playerRight.gif"); // replace
   ...
   // attackers can also be affected by the clouds
